...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None):
    ...
    ############################################################################
    out1 , chche1 = affine_relu_forward(X,self.params['W1'],self.params['b1'])
    
    scores , chche2 = affine_forward(out1,self.params['W2'],self.params['b2'])
    ...
    dout1,dw2,db2 = affine_backward(dscores,chche2)
    grads['W2'] = dw2 + self.reg * self.params['W2']
    grads['b2'] = db2
    dX,dw1,db1 = affine_relu_backward(dout1,chche1)
